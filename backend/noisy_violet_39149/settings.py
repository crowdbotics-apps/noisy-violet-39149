"""
Django settings for noisy_violet_39149 project.
...
ROOT_URLCONF = 'noisy_violet_39149.urls'
...
WSGI_APPLICATION = 'noisy_violet_39149.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_violet_39149 API",
    "DESCRIPTION": "API documentation for noisy_violet_39149 App",
    "VERSION": "v1",
}
